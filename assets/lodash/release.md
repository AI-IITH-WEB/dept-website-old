...
npm run doc
npm i
git clone --depth=10 --branch=master git@github.com:lodash-archive/lodash-cli.git ./assets/lodash-cli
mkdir -p ./assets/lodash-cli/assets/lodash; cd $_; cp ../../../../lodash.js ./lodash.js; cp ../../../../package.json ./package.json
cd ../../; npm i --production; cd ../../
node ./assets/lodash-cli/bin/lodash core exports=node -o ./npm-package/core.js
node ./assets/lodash-cli/bin/lodash modularize exports=node -o ./npm-package
